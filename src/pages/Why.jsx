            ...
            <section className='flex flex-col gap-2 p-2'>
                ...
                <section>
                    <section className='flex justify-center  gap-5 mt-10 '>
                        ...
                        <div>
                            <h3 className='text-primaryHead font-bold sm:text-xl'>24 Hours support</h3>
                            <p className='text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit blanditiis ex fuga,</p>
                        </div>
                    </section>
                    <section className='flex justify-center  gap-5 mt-10 '>
                        <div className=' text-white bg-primaryBtn h-fit p-4 rounded-md'>
